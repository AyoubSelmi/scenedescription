...
import os
os.chdir('C:\\Users\\Ayoub\\Desktop\\Scene_description')
...
def predict():
    ...
    checkpoint_path = "./checkpoint_finally19/train/ckpt-4"
    ...
    req_img = request.files.getlist("images")[0]
    Image_path=os.path.join(os.getcwd(), 'new_'+req_img.filename)
    req_img.save(Image_path)
    def evaluate(image):
    ...
    captn =' '
    return captn.join(result).rsplit(' ', 1)[0]
